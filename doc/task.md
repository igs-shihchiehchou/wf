...
### 3.1 裁切功能
- [x] UI 雙手柄滑桿（符合 plan.md 設計）
- [x] 實現音訊裁切邏輯（Web Audio API）
- [x] 測試裁切功能是否正常
- [x] 驗證邊界情況（開始 > 結束、超出範圍等）
...
### Git Commits
```
✅ feat: implement dual-handle range slider for crop
✅ feat: improve crop UI with range sliders and inputs
✅ test: verify all audio editing features
```
